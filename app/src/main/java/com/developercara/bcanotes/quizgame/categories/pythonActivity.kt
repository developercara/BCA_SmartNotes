...
class pythonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myRef = database.getReference("python")
...
//                    Log.e("QuizGame", "Failed to read value.", error.toException())
    ...
    private fun startTimer() {
        countDownTimer = object : CountDownTimer(20000, 1000) {
            ...
            override fun onFinish() {
                val dialog = Dialog(this@pythonActivity)
                dialog.setContentView(R.layout.timeout_dialog)
                dialog.show()
                dialog.findViewById<View>(R.id.tryagain).setOnClickListener {
                    val intent = Intent(this@pythonActivity, MainActivity::class.java)
    ...
    private fun startTimerinstance(){
        countDownTimer = object : CountDownTimer(20000, 1000) {
            ...
            override fun onFinish() {
                ...
                dialog.show()
                dialog.findViewById<View>(R.id.tryagain).setOnClickListener {
                    val intent = Intent(this@pythonActivity, MainQuiz::class.java)
                    startActivity(intent)
                }
            }
        }.start()
    ...
    private fun gameWon() {
        val intent = Intent(this@pythonActivity, WonActivity::class.java)
