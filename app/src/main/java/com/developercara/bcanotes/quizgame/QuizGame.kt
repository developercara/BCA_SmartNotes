...
//                    Log.e("QuizGame", "Failed to read value.", error.toException())
    ...
    private fun startTimer() {
        countDownTimer = object : CountDownTimer(20000, 1000) {
            ...
            override fun onFinish() {
                val dialog = Dialog(this@QuizGame)
                dialog.setContentView(R.layout.timeout_dialog)
                dialog.show()
                dialog.findViewById<View>(R.id.tryagain).setOnClickListener {
                    val intent = Intent(this@QuizGame, MainActivity::class.java)
    ...
    private fun gameWon() {
        val intent = Intent(this@QuizGame, WonActivity::class.java)
    ...
    private fun resetColor() {
        cardOA.setCardBackgroundColor(ContextCompat.getColor(this, R.color.white))
        cardOB.setCardBackgroundColor(ContextCompat.getColor(this, R.color.white))
        cardOC.setCardBackgroundColor(ContextCompat.getColor(this, R.color.white))
        cardOD.setCardBackgroundColor(ContextCompat.getColor(this, R.color.white))
    }
