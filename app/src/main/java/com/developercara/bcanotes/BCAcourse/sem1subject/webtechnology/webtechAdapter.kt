...
class webtechAdapter constructor(
    private val getActivity: webtechActivity,
    private val cList: List<Others>
) : RecyclerView.Adapter<webtechAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.other_click.setOnClickListener {
            val intent = Intent(getActivity, webtectSY::class.java)
