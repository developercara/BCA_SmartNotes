...
import com.developercara.bcanotes.BCAcourse.sem2.Sems2Activity
import com.developercara.bcanotes.R
import com.developercara.bcanotes.dataclass.Semes

class SemesAdapter constructor(private val getActivity: BcacourseActivity, private val semesList: List<Semes>):
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener{
            val intent = when (position) {
                ...
                1 -> Intent(getActivity, Sems2Activity::class.java)
