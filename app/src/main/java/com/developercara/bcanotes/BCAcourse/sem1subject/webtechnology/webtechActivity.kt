package com.developercara.bcanotes.BCAcourse.sem1subject.webtechnology
...
import com.developercara.bcanotes.databinding.ActivityWebtechBinding
import com.developercara.bcanotes.dataclass.Others

class webtechActivity : AppCompatActivity() {
    lateinit var binding: ActivityWebtechBinding

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: webtechAdapter
    private val cList = mutableListOf<Others>()
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityWebtechBinding.inflate(layoutInflater)
        super.onCreate(savedInstanceState)
        setContentView(binding.root)

        recyclerView = binding.recyclerc
        adapter = webtechAdapter(this, cList)
