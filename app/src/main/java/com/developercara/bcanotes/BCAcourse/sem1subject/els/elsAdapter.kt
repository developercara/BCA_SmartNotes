...
class elsAdapter  constructor(
    private val getActivity: ELSActivity,
    private val cList: List<Others>
) : RecyclerView.Adapter<elsAdapter .MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.other_click.setOnClickListener {
            val intent = Intent(getActivity, ElsViewer::class.java)
