...
import com.developercara.bcanotes.BCAcourse.sem2.EVS.EVSActivity
...
class  EcoAdapter constructor(
    private val getActivity: EcoActivity,
    private val cList: List<Others>
) : RecyclerView.Adapter<EcoAdapter.MyViewHolder>() {
