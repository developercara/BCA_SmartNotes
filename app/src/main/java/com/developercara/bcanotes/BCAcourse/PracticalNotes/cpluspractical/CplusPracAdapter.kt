...
class CplusPracAdapter constructor(
    private val getActivity: CplusPracActivity,
    private val cList: List<Others>
) : RecyclerView.Adapter<CplusPracAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.other_click.setOnClickListener {
            val intent = Intent(getActivity, CplusPracViewer::class.java)
