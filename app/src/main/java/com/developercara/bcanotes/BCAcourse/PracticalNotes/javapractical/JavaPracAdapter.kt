...
class JavaPracAdapter constructor(
    private val getActivity: JavaPracActivity,
    private val cList: List<Others>
) : RecyclerView.Adapter<JavaPracAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.other_click.setOnClickListener {
            val intent = Intent(getActivity, JavaPracViewer::class.java)
