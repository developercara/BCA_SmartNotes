...
import com.developercara.bcanotes.databinding.ActivityCprogrammingUnit3Binding
import com.github.barteksc.pdfviewer.PDFView
import com.google.firebase.ktx.Firebase
import com.google.firebase.storage.ktx.storage

class CprogrammingUnit3 : AppCompatActivity() {
    lateinit var binding: ActivityCprogrammingUnit3Binding
    private lateinit var pdfView: PDFView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding =ActivityCprogrammingUnit3Binding.inflate(layoutInflater)
        ...
        val pdfRef = storageRef.child("/semester1/cprogramming/unit3.pdf")
        showProgressBar()
