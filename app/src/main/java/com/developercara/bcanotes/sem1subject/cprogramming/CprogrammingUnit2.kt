...
import com.developercara.bcanotes.databinding.ActivityCprogrammingUnit2Binding
import com.github.barteksc.pdfviewer.PDFView
import com.google.firebase.ktx.Firebase
import com.google.firebase.storage.ktx.storage

class CprogrammingUnit2 : AppCompatActivity() {
    lateinit var binding: ActivityCprogrammingUnit2Binding
    private lateinit var pdfView: PDFView
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityCprogrammingUnit2Binding.inflate(layoutInflater)
        ...
        val pdfRef = storageRef.child("/semester1/cprogramming/unit2.pdf")
        showProgressBar()
